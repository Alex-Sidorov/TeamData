/****************************************************************************
** Meta object code from reading C++ file 'taskrecvfile.h'
**
...
#include "../../src/Client/Tasks/taskrecvfile.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'taskrecvfile.h' doesn't include <QObject>."
...
void TasksClient::TaskRecvFile::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (TaskRecvFile::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TaskRecvFile::recved_data)) {
                *result = 0;
                return;
            }
        }
