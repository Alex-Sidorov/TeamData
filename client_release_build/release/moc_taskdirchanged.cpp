/****************************************************************************
** Meta object code from reading C++ file 'taskdirchanged.h'
**
...
#error "The header file 'taskdirchanged.h' doesn't include <QObject>."
...
void TasksClient::TaskDirChanged::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->complete_task((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (TaskDirChanged::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TaskDirChanged::complete_task)) {
                *result = 0;
                return;
            }
        }
