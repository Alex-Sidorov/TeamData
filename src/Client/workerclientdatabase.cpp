...
/*const char* WorkerClientDataBase::INSERT_TASK_FILE_USER_REQUEST =
        "INSERT INTO tasks_files (name,path, last_modified_date, local_last_modified_date) "
        "VALUES(:name,:path, :last_modified_date, :local_last_modified_date);";
const char* WorkerClientDataBase::UPDATE_LOCAL_LAST_MODIFIED_DATE_FILE_REQUEST =
        "UPDATE tasks_files SET local_last_modified_date = :local_last_modified_date "
        "WHERE name = :name AND path = :path;";
const char* WorkerClientDataBase::SELECT_DATES_LAST_MODIFIED_FILE_REQUEST =
        "SELECT last_modified_date, local_last_modified_date FROM tasks_files"
        "WHERE name = :name AND path = :path;";
const char* WorkerClientDataBase::DELETE_ANY_TASK_FILE_USER_REQUEST =
        "DELETE FROM tasks_files WHERE name = :name AND path = :path;";
const char* WorkerClientDataBase::DELETE_TASKS_FILES_USER_REQUEST =
        "DELETE FROM tasks_files WHERE name = :name";*/
