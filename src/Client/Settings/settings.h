...
namespace SettingsClient
{
    class Settings
    {
        using DBWorker = DataBaseWork::WorkerClientDataBase;
    public:
        ...
        DBWorker::DirsPath get_data_dir_user(const QString &user);

        bool change_data_files_user(const QString &user, const DBWorker::FileMetaData &data);
        DBWorker::FileMetaData get_data_files_user(const QString &user);
        ...
        DBWorker::Tasks get_all_task_user(const QString &user)const;
        DBWorker::UsersTasks get_all_task_users()const;
