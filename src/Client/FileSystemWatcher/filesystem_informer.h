...
namespace FileSystemWatcher
{
    ...
    {
    public:
        static QStringList parse_directory(const QString &path, uint16_t filter, bool is_sub_dir = true);
        ...
        static QStringList get_directory(const QString &path);
        ...
        static QStringList get_files(const QString &path, bool is_sub_dir = true);
