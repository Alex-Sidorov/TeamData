...
#include "../../src/Client/BaseServer/base_server.h"
...
void DataTransfer::BaseServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (BaseServer::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&BaseServer::recved_data)) {
                *result = 4;
                return;
            }
        }
...
// SIGNAL 4
void DataTransfer::BaseServer::recved_data()
{
